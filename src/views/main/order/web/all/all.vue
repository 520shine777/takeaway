<template>
  <div class="orders-today">
    <el-table :data="paginationOrders" :default-sort="{ prop: 'id', order: 'descending' }" style="width: 100%">
      ...
      <el-table-column label="订单信息">
        ...
        <el-table-column label="订单状态" width="120">
          <template slot-scope="scope">
            <el-tag :type="scope.row.done ? 'primary' : 'success'" disable-transitions>{{ scope.row.done ? "进行中" : "已完成"
            }}</el-tag>
          </template>
        </el-table-column>
      </el-table-column>
    ...
    <div class="pagination">
      <el-pagination background @current-change="currentChange" @size-change="sizeChange" :current-page="currentPage"
        :page-size="pageSize" :page-sizes="[10, 20, 30, 50, 70, 100, 500]"

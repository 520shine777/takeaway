    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card title="店铺食品销量">
          <base-echarts :option="soldOption" v-if="soldOption.series[0].name"></base-echarts>
        </el-card>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="8">
        <el-card title="店铺账单">
          <base-echarts :option="billOption" v-if="billOption.series[0].data.length"></base-echarts>
        </el-card>
      </el-col>
      <el-col :span="16">
        <el-card title="订单地点分布">
          <base-echarts :showMap="true" height="400px" :option="mapOption"
            v-if="mapOption.series[2].data.length"></base-echarts>
        </el-card>
      </el-col>
    </el-row>
  </div>

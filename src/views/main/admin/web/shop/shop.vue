<template>
  <div class="shop-manage">
    <div class="search-form">
      <search-form :searchConfig="ShopSearchFormConfig" @resetSearchForm="resetSearchForm"
        @searchFormRequest="searchFormRequest" />
    </div>

    <div class="table-data">
      <table-form :tableData="defaultShowInfo" v-bind="ShopTableFormConfig" @handleOffsetChange="handleOffsetChange"
        ...
        <template #handle="slotProps">
          ...
          <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" icon="el-icon-info" icon-color="red"
            title="确定要删除该账号吗？" @confirm="deleteShop(slotProps.row)">
